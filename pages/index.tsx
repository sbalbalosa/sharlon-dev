          ...
          <div className="flex flex-col">
            <div className="flex flex-row items-center justify-between mt-24 mb-12">
              <Image
                ...
                alt="Picture of Sharlon Balbalosa"
              />
              <a className="hidden text-gray-600 uppercase cursor-pointer md:block hover:text-white">About</a>
              <a className="hidden text-gray-600 uppercase cursor-pointer md:block hover:text-white">Services</a>
              <a className="hidden text-gray-600 uppercase cursor-pointer md:block hover:text-white">Why us</a>
              <a className="hidden text-gray-600 uppercase cursor-pointer md:block hover:text-white">Contact</a>
